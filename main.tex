...
\begin{figure}
\centering
\includegraphics[height=7.5cm,keepaspectratio]{processing_pipeline_2.png}
\end{figure}
\end{frame}


\begin{frame}
\frametitle{Key Design Choices}
\begin{itemize}
...
\begin{block}{Code:}
\begin{figure}
\url{https://github.com/kdskibin/morph_tagger}\\[1em]
\includegraphics[height=6cm,keepaspectratio]{qr_code.png}
\end{figure}
\end{block}
\end{frame}
\end{document}